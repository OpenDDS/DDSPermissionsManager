...
describe('Group Capabilities', () => {
	...
	it('should add a new group', () => {
		...
		cy.get('[data-cy="group-new-name"]').type('TestGroup');

		cy.get('[data-cy="button-add-group"]').click();
	...
	it('should edit the name of a group', () => {
		...
		cy.get('[data-cy="edit-group-icon-TestGroup"]').click();

		cy.get('[data-cy="group-new-name"]').clear().type('NewGroup');
	...
	it('should delete a group', () => {
		...
		cy.get('[data-cy="delete-group-icon-NewGroup"]').click();
	...
	it('should navigate to the link', () => {
		...
		cy.get(':nth-child(1) > :nth-child(5) > center').click();
